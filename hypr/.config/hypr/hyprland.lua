...
hl.on("hyprland.start", function()
    ...
    hl.exec_cmd("pgrep -xf 'wl-paste --type text --watch cliphist store' >/dev/null || wl-paste --type text --watch cliphist store")
    hl.exec_cmd("pgrep -xf 'wl-paste --type image --watch cliphist store' >/dev/null || wl-paste --type image --watch cliphist store")
